...
void            Bureaucrat::executeForm(Form const & form)
{
    ...
    {
        std::cout << _name << " cannot execute form because of: " << e.what() << std::endl;
    }
}
...
void            Bureaucrat::signForm( Form  & forma ) const
{
    ...
    {
        forma.beSigned(*this);
        std::cout << "Bureaucrat " << _name << " successfully signed "
        << forma.getName() << "!" << std::endl;
    }
    catch (std::exception & e)
    {
        std::cout << "Bureaucrat " << _name << " cannot sign form "
        << forma.getName() << " for a reason: " << e.what() << std::endl;
    }
}
